...
namespace BackEnd
{
    public partial class ManageOrderForm : Form
    {
        ...
        Int32 DisplayOrders(string EmailFilter)
        {
            ...
            listOrders.DataSource = AllOrders.OrderList;
            //set the name of the primary Key
            listOrders.ValueMember = "OrderId";
            //set the data field to display

            listOrders.DisplayMember = "AllDetails";
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (listOrders.SelectedIndex != -1)
            {
                ...
                OrderId = Convert.ToInt32(listOrders.SelectedValue);
        ...
        private void btnApply_Click(object sender, EventArgs e)
        {
            ...
            RecordCount = DisplayOrders(txtFilter.Text);
